...
const ForgotPassword = ({ history }) =>{
    ...
    return(
        <div className="forgot-password" style={themeVal}>
            <div className="forgot-password-form">
                {(forgotPasswordLoading || resetPasswordLoading) && <Loader />} 
                <h5> <img src={logo} alt='' /> {!showResetPassword ? 'Forgot Password' : 'Reset Password'} </h5>
                <form onSubmit={e=>{return !showResetPassword ? handleGetOTP(e) : handleResetPassword(e)}}>
                    ...
                    </div>
                    {
                        ...
                        <>
                            <div className="input-field">
                                <input id="otp" type="text" value={resetPasswordOTP} style={themeVal}
